...
Song.create(title: 'Food For The Masses', album_id: 2, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Spearhead+-+Chocolate+Supa+Highway/Spearhead-Food-For-Tha-Masses.mp3', track_num: 4, duration: 302, plays: 50000)
Song.create(title: 'Chocolate Supa Highway', album_id: 2, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Spearhead+-+Chocolate+Supa+Highway/Spearhead+-+Chocolate+Supa+Highway.mp3', track_num: 4, duration: 302, plays: 50000)
Song.create(title: "U Can't Sing R Song", album_id: 2, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Spearhead+-+Chocolate+Supa+Highway/Spearhead-U-Cant-Sing-R-Song.mp3', track_num: 5, duration: 327, plays: 40000)
Song.create(title: "Wayfarin' Stranger", album_id: 2, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Spearhead+-+Chocolate+Supa+Highway/Spearhead-Wayfarin-Stranger.mp3', track_num: 13, duration: 328, plays: 333333)
Song.create(title: "Le chateau magique", album_id: 3, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Guilhem+Desq+-+Visions/01+-+Le+cha%CC%82teau+magique.mp3', track_num: 1, duration: 250, plays: 222222)
Song.create(title: "Omen", album_id: 3, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/Guilhem+Desq+-+Visions/06+-+Omen.mp3', track_num: 6, duration: 221, plays: 222222)
Song.create(title: "Tear It Down", album_id: 4, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/SOJA+-+Amid+the+Noise+and+Haste/01+-+Tear+It+Down.mp3', track_num: 1, duration: 249, plays: 111111)
Song.create(title: "Talking To Myself", album_id: 4, song_url: 'https://stupify-dev.s3.us-west-1.amazonaws.com/Songs/SOJA+-+Amid+the+Noise+and+Haste/15+-+Talking+To+Myself+(Bonus+Track).mp3', track_num: 15, duration: 222, plays: 111111)
